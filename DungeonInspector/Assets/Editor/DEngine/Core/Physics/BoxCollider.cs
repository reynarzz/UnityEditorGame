...
namespace DungeonInspector
{
    public class DBoxCollider : DBehavior
    {
        ...
        {
            DIEngineCoreServices.Get<DRenderingController>().AddDebugGUI(DebugGUI);
        }
        ...
        {
            DIEngineCoreServices.Get<DRenderingController>().RemoveDebugGUI(DebugGUI);
        }
    }
}
