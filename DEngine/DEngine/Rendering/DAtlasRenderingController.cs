...
{
    public class DAtlasRenderingController : DRenderingControllerBase<DAtlasRendererComponent>
    {
        // TODO: this code is almost the same as DSpriteRenderingController, please reuse.
        protected override void Draw(DAtlasRendererComponent renderer, DCamera camera, Material defaultMat, Texture2D defaultTex)
        {
            if (camera != null && renderer.Entity.IsActive && renderer.Enabled)
            {
                ...
                var atlasTex = renderer.AtlasInfo.Texture;
                var blockSize = renderer.AtlasInfo.BlockSIze;
                ...
                mat.SetVector("_AtlasRect", new Vector4(renderer.SpriteCoord.x / width, renderer.SpriteCoord.y / height, width, height));
